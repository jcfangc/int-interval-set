...
const QUERIES: &[(&str, Bounds)] = &[
    ...
    ("partial_two_intervals", (258, 274)),
    ("span_all_alternating", (0, 1024)),
];
...
/// ```
///
/// Within `[0, 1024)`, exactly half of the coordinates are covered.
...
fn bench_coverage_ratio_f64_of(c: &mut Criterion) {
...
criterion_group! {
    ...
    targets = bench_coverage_ratio_f64_of
}
