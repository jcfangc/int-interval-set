...
use crate::u128::funcs_for_canonicalization::{is_canonical, merge, normalize};
...
impl U128COSet {
    ...
    #[inline]
    pub(super) unsafe fn new_unchecked(intervals: Vec<U128CO>) -> Self {
...
impl FromIterator<U128CO> for U128COSet {
        ...
        I: IntoIterator<Item = U128CO>,
    {
        ...
        unsafe { U128COSet::new_unchecked(reduced) }
    }
}

impl FromParallelIterator<U128CO> for U128COSet {
    fn from_par_iter<I>(iter: I) -> Self
    where
        I: IntoParallelIterator<Item = U128CO>,
    {
        let reduced = iter
            .into_par_iter()
            .fold(
                || (Vec::with_capacity(BATCH_SIZE), Vec::<U128CO>::new()),
