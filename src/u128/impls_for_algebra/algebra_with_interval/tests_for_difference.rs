...
fn difference_handles_domain_edges() {
    let set = build([(u128::MIN, u128::MIN + 10), (u128::MAX - 10, u128::MAX)]);

    assert_eq!(
        set.difference_with_interval(iv(u128::MIN, u128::MIN + 5))
            .as_slice(),
        &[iv(u128::MIN + 5, u128::MIN + 10), iv(u128::MAX - 10, u128::MAX)]
    );

    assert_eq!(
        set.difference_with_interval(iv(u128::MAX - 5, u128::MAX))
            .as_slice(),
        &[iv(u128::MIN, u128::MIN + 10), iv(u128::MAX - 10, u128::MAX - 5)]
    );
}
