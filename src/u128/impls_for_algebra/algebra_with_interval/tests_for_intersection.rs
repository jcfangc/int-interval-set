...
fn intersections_handles_domain_edges() {
    ...
    assert_eq!(
        set.intersection_with_interval(iv(u128::MIN, u128::MIN + 1))
            .as_slice()
            .to_vec(),
        vec![iv(u128::MIN, u128::MIN + 1)]
    );
    assert_eq!(
        set.intersection_with_interval(iv(u128::MAX - 1, u128::MAX))
            .as_slice()
            .to_vec(),
        vec![iv(u128::MAX - 1, u128::MAX)]
    );
}
