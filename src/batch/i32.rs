...
#[repr(transparent)]
pub struct I32COBatchSet(Vec<I32CO>);
...
impl I32COBatchSet {
    #[inline]
    pub fn into_inner(self) -> Vec<I32CO> {
        self.0
    }
...
impl I32COBatchSet {
    #[inline]
    pub fn contains_interval(&self, iv: I32CO) -> bool {
    ...
    #[inline]
    pub fn intersects(&self, q: I32CO) -> bool {
        let slice = self.as_slice();
...
impl I32COBatchSet {
    ...
    #[inline]
    pub fn iter_points(&self) -> impl Iterator<Item = i32> {
        self.iter_intervals().flat_map(I32CO::iter)
    }
}
...
impl I32COBatchSet {
    ...
    #[inline]
    pub fn coverage_len_of(&self, q: I32CO) -> u32 {
        let slice = self.as_slice();
    ...
    #[inline]
    pub fn coverage_ratio_of(&self, q: I32CO) -> f32 {
...
mod construction {
    ...
    #[inline]
    fn normalize(mut xs: Vec<I32CO>) -> Vec<I32CO> {
        if xs.len() <= 1 {
            return xs;
        }
    ...
    impl From<Vec<I32CO>> for I32COBatchSet {
        #[inline]
        fn from(value: Vec<I32CO>) -> Self {
            Self(normalize(value))
        }
    }

    impl<const N: usize> From<[I32CO; N]> for I32COBatchSet {
        #[inline]
        fn from(value: [I32CO; N]) -> Self {
            Self::from(Vec::from(value))
        }
    }

    impl FromIterator<I32CO> for I32COBatchSet {
        #[inline]
        fn from_iter<T: IntoIterator<Item = I32CO>>(iter: T) -> Self {
