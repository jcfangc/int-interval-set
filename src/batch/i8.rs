...
#[repr(transparent)]
pub struct I8COBatchSet(Vec<I8CO>);
...
impl I8COBatchSet {
    #[inline]
    pub fn into_inner(self) -> Vec<I8CO> {
        self.0
    }
...
impl I8COBatchSet {
    #[inline]
    pub fn contains_interval(&self, iv: I8CO) -> bool {
    ...
    #[inline]
    pub fn intersects(&self, q: I8CO) -> bool {
        let slice = self.as_slice();
...
impl I8COBatchSet {
    ...
    #[inline]
    pub fn iter_points(&self) -> impl Iterator<Item = i8> {
        self.iter_intervals().flat_map(I8CO::iter)
    }
}
...
impl I8COBatchSet {
    ...
    #[inline]
    pub fn coverage_len_of(&self, q: I8CO) -> u8 {
        let slice = self.as_slice();
    ...
    #[inline]
    pub fn coverage_ratio_of(&self, q: I8CO) -> f32 {
...
mod construction {
    ...
    #[inline]
    fn normalize(mut xs: Vec<I8CO>) -> Vec<I8CO> {
        if xs.len() <= 1 {
            return xs;
        }
    ...
    impl From<Vec<I8CO>> for I8COBatchSet {
        #[inline]
        fn from(value: Vec<I8CO>) -> Self {
            Self(normalize(value))
        }
    }

    impl<const N: usize> From<[I8CO; N]> for I8COBatchSet {
        #[inline]
        fn from(value: [I8CO; N]) -> Self {
            Self::from(Vec::from(value))
        }
    }

    impl FromIterator<I8CO> for I8COBatchSet {
        #[inline]
        fn from_iter<T: IntoIterator<Item = I8CO>>(iter: T) -> Self {
