...
use crate::i8::funcs_for_canonicalization::{is_canonical, merge, normalize};
...
impl I8COSet {
    ...
    #[inline]
    pub(super) unsafe fn new_unchecked(intervals: Vec<I8CO>) -> Self {
...
impl FromIterator<I8CO> for I8COSet {
        ...
        I: IntoIterator<Item = I8CO>,
    {
        ...
        unsafe { I8COSet::new_unchecked(reduced) }
    }
}

impl FromParallelIterator<I8CO> for I8COSet {
    fn from_par_iter<I>(iter: I) -> Self
    where
        I: IntoParallelIterator<Item = I8CO>,
    {
        let reduced = iter
            .into_par_iter()
            .fold(
                || (Vec::with_capacity(BATCH_SIZE), Vec::<I8CO>::new()),
