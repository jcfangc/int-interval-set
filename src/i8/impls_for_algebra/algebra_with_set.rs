...
use crate::i8::funcs_for_canonicalization::{canonicalize_sorted, merge_sorted};
    ...
    pub fn difference_with_set(&self, other: &Self) -> Self {
        ...
        for source in self.intervals.iter().copied() {
            ...
            while scan < other.intervals.len() {
                ...
                if let Some(residual) = I8CO::try_new(cursor, removed.start()) {
            ...
            if let Some(residual) = I8CO::try_new(cursor, source.end_excl()) {
                intervals.push(residual);
            }
        ...
        while left_events.peek().is_some() || right_events.peek().is_some() {
            ...
            match (
                ...
                (true, false) => {
                    ...
                    let interval = I8CO::try_new(start, x)
