...
/// Read-only canonical interval set for `U64CO`.
///
/// A `U64COSet` stores a normalized collection of half-open `U64CO` intervals:
///
...
///
/// Construction is intentionally restricted. Use `U64COSetBuilder` for normal
/// construction.
pub mod set {
    use super::*;
    ...
    mod basic {
        ...
        impl U64COSet {
            ...
            #[inline]
            pub(in crate::u64) unsafe fn new_unchecked(intervals: Vec<U64CO>) -> Self {
            ...
            #[inline]
            fn is_canonical(intervals: &[U64CO]) -> bool {
...
/// Concurrent builder for `U64COSet`.
///
...
pub mod builder {
    ...
    use super::set::U64COSet;
    use super::*;

    /// Private ordering key for storing `U64CO` inside `SkipSet`.
    ///
    /// `U64CO` does not need to implement `Ord` in its own crate. This wrapper
    ...
    /// Concurrent write-side builder for `U64COSet`.
    ///
    ...
    pub struct U64COSetBuilder {
        raw: SkipSet<Key>,
    }

    impl U64COSetBuilder {
        ...
        pub fn seal(self) -> U64COSet {
            ...
            // intervals.
            unsafe { U64COSet::new_unchecked(out) }
        }
    }
}
