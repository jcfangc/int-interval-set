...
fn intersections_handles_domain_edges() {
    ...
    assert_eq!(
        set.intersection_with_interval(iv(u32::MIN, u32::MIN + 1))
            .as_slice()
            .to_vec(),
        vec![iv(u32::MIN, u32::MIN + 1)]
    );
    assert_eq!(
        set.intersection_with_interval(iv(u32::MAX - 1, u32::MAX))
            .as_slice()
            .to_vec(),
        vec![iv(u32::MAX - 1, u32::MAX)]
    );
}
