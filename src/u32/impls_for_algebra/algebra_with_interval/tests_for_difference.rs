...
fn difference_handles_domain_edges() {
    let set = build([(u32::MIN, u32::MIN + 10), (u32::MAX - 10, u32::MAX)]);

    assert_eq!(
        set.difference_with_interval(iv(u32::MIN, u32::MIN + 5))
            .as_slice(),
        &[iv(u32::MIN + 5, u32::MIN + 10), iv(u32::MAX - 10, u32::MAX)]
    );

    assert_eq!(
        set.difference_with_interval(iv(u32::MAX - 5, u32::MAX))
            .as_slice(),
        &[iv(u32::MIN, u32::MIN + 10), iv(u32::MAX - 10, u32::MAX - 5)]
    );
}
