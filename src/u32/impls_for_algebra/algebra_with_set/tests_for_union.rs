...
fn union_handles_domain_edges() {
    let left = build([(u32::MIN, u32::MIN + 10), (u32::MAX - 10, u32::MAX)]);
    let right = build([(u32::MIN + 10, u32::MAX - 10)]);
...
proptest! {
    ...
    fn prop_union_matches_pointwise_membership(
        ...
        let left: U32COSet = xs.into_iter().collect();
        let right: U32COSet = ys.into_iter().collect();
