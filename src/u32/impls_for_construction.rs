...
use crate::u32::funcs_for_canonicalization::{is_canonical, merge, normalize};
...
impl U32COSet {
    ...
    #[inline]
    pub(super) unsafe fn new_unchecked(intervals: Vec<U32CO>) -> Self {
...
impl FromIterator<U32CO> for U32COSet {
        ...
        I: IntoIterator<Item = U32CO>,
    {
        ...
        unsafe { U32COSet::new_unchecked(reduced) }
    }
}

impl FromParallelIterator<U32CO> for U32COSet {
    fn from_par_iter<I>(iter: I) -> Self
    where
        I: IntoParallelIterator<Item = U32CO>,
    {
        let reduced = iter
            .into_par_iter()
            .fold(
                || (Vec::with_capacity(BATCH_SIZE), Vec::<U32CO>::new()),
