...
fn union_handles_domain_edges() {
    let left = build([(u64::MIN, u64::MIN + 10), (u64::MAX - 10, u64::MAX)]);
    let right = build([(u64::MIN + 10, u64::MAX - 10)]);
...
proptest! {
    ...
    fn prop_union_matches_pointwise_membership(
        ...
        let left: U64COSet = xs.into_iter().collect();
        let right: U64COSet = ys.into_iter().collect();
