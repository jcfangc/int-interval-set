...
fn difference_handles_domain_edges() {
    let set = build([(u64::MIN, u64::MIN + 10), (u64::MAX - 10, u64::MAX)]);

    assert_eq!(
        set.difference_with_interval(iv(u64::MIN, u64::MIN + 5))
            .as_slice(),
        &[iv(u64::MIN + 5, u64::MIN + 10), iv(u64::MAX - 10, u64::MAX)]
    );

    assert_eq!(
        set.difference_with_interval(iv(u64::MAX - 5, u64::MAX))
            .as_slice(),
        &[iv(u64::MIN, u64::MIN + 10), iv(u64::MAX - 10, u64::MAX - 5)]
    );
}
