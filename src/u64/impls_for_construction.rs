...
use crate::u64::funcs_for_canonicalization::{is_canonical, merge, normalize};
...
impl U64COSet {
    ...
    #[inline]
    pub(super) unsafe fn new_unchecked(intervals: Vec<U64CO>) -> Self {
...
impl FromIterator<U64CO> for U64COSet {
        ...
        I: IntoIterator<Item = U64CO>,
    {
        ...
        unsafe { U64COSet::new_unchecked(reduced) }
    }
}

impl FromParallelIterator<U64CO> for U64COSet {
    fn from_par_iter<I>(iter: I) -> Self
    where
        I: IntoParallelIterator<Item = U64CO>,
    {
        let reduced = iter
            .into_par_iter()
            .fold(
                || (Vec::with_capacity(BATCH_SIZE), Vec::<U64CO>::new()),
