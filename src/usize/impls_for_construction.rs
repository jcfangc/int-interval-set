...
use crate::usize::funcs_for_canonicalization::{is_canonical, merge, normalize};
...
impl UsizeCOSet {
    ...
    #[inline]
    pub(super) unsafe fn new_unchecked(intervals: Vec<UsizeCO>) -> Self {
...
impl FromIterator<UsizeCO> for UsizeCOSet {
        ...
        I: IntoIterator<Item = UsizeCO>,
    {
        ...
        unsafe { UsizeCOSet::new_unchecked(reduced) }
    }
}

impl FromParallelIterator<UsizeCO> for UsizeCOSet {
    fn from_par_iter<I>(iter: I) -> Self
    where
        I: IntoParallelIterator<Item = UsizeCO>,
    {
        let reduced = iter
            .into_par_iter()
            .fold(
                || (Vec::with_capacity(BATCH_SIZE), Vec::<UsizeCO>::new()),
