...
fn intersections_handles_domain_edges() {
    ...
    assert_eq!(
        set.intersection_with_interval(iv(usize::MIN, usize::MIN + 1))
            .as_slice()
            .to_vec(),
        vec![iv(usize::MIN, usize::MIN + 1)]
    );
    assert_eq!(
        set.intersection_with_interval(iv(usize::MAX - 1, usize::MAX))
            .as_slice()
            .to_vec(),
        vec![iv(usize::MAX - 1, usize::MAX)]
    );
}
