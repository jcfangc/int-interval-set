...
fn contains_point_works_across_multiple_intervals() {
    ...
    assert!(!set.contains_point(usize::MAX));
}
...
fn contains_point_works_on_empty_set() {
    ...
    assert!(!set.contains_point(usize::MIN));
    assert!(!set.contains_point(usize::MAX / 2));
    assert!(!set.contains_point(usize::MAX));
}
...
fn contains_interval_works_on_empty_set() {
    ...
    assert!(!set.contains_interval(iv(usize::MAX - 1, usize::MAX)));
}
...
fn intersects_interval_works_on_empty_set() {
    ...
    assert!(!set.intersects_interval(iv(usize::MAX - 1, usize::MAX)));
}
...
fn predicates_handle_domain_edges() {
    ...
    assert!(set.contains_point(usize::MIN));
    assert!(!set.contains_point(usize::MIN + 1));

    assert!(set.contains_point(usize::MAX - 1));
    assert!(!set.contains_point(usize::MAX));

    assert!(set.contains_interval(iv(usize::MIN, usize::MIN + 1)));
    assert!(set.contains_interval(iv(usize::MAX - 1, usize::MAX)));

    assert!(set.intersects_interval(iv(usize::MIN, usize::MIN + 1)));
    assert!(set.intersects_interval(iv(usize::MAX - 1, usize::MAX)));
}
