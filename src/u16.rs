...
/// Read-only canonical interval set for `U16CO`.
///
/// A `U16COSet` stores a normalized collection of half-open `U16CO` intervals:
///
...
///
/// Construction is intentionally restricted. Use `U16COSetBuilder` for normal
/// construction.
pub mod set {
    use super::*;
    ...
    mod basic {
        ...
        impl U16COSet {
            ...
            #[inline]
            pub(in crate::u16) unsafe fn new_unchecked(intervals: Vec<U16CO>) -> Self {
            ...
            ///
            /// `U16CO` itself already guarantees single-interval validity. This
            /// function only checks the relationship between adjacent intervals.
            #[inline]
            fn is_canonical(intervals: &[U16CO]) -> bool {
        ...
        impl U16COSet {
            ...
            ///
            /// For the `U16CO` domain, the maximum canonical interval count is
    ...
    mod predicates {
        ...
        impl U16COSet {
            ...
            /// Complexity: `O(log n)`.
            #[inline]
            pub fn contains_point(&self, x: u16) -> bool {
            ...
            /// Complexity: `O(log n)`.
            #[inline]
            pub fn contains_interval(&self, query: U16CO) -> bool {
                let i = self
                    .intervals
            ...
            /// Complexity: `O(log n)`.
            #[inline]
            pub fn intersects_interval(&self, query: U16CO) -> bool {
                let i = self
                    .intervals
    ...
    mod search {
        ...
        mod point {
            ...
            impl U16COSet {
                ...
                /// Complexity: `O(log n)`.
                #[inline]
                pub fn interval_containing_point(&self, x: u16) -> Option<U16CO> {
                    let i = self.intervals.partition_point(|iv| iv.start() <= x);
        ...
        mod interval {
            ...
            impl U16COSet {
                ...
                /// returned intervals.
                #[inline]
                pub fn intervals_intersecting(&self, query: U16CO) -> impl Iterator<Item = U16CO> {
                    let i = self
                        .intervals
                        .partition_point(|iv| iv.end_excl() <= query.start());
                ...
                #[inline]
                pub fn intersections(&self, query: U16CO) -> impl Iterator<Item = U16CO> {
    ...
    mod coverage {
        ...
        impl U16COSet {
            ...
            /// empty interval.
            #[inline]
            pub fn coverage_ratio(&self, query: U16CO) -> f32 {
...
/// Concurrent builder for `U16COSet`.
///
...
pub mod builder {
    ...
    use super::set::U16COSet;
    use super::*;

    /// Private ordering key for storing `U16CO` inside `SkipSet`.
    ///
    /// `U16CO` does not need to implement `Ord` in its own crate. This wrapper
    ...
    /// Concurrent write-side builder for `U16COSet`.
    ///
    ...
    pub struct U16COSetBuilder {
        raw: SkipSet<Key>,
    }

    impl U16COSetBuilder {
        ...
        pub fn seal(self) -> U16COSet {
            ...
            // intervals.
            unsafe { U16COSet::new_unchecked(out) }
        }
    }
}
