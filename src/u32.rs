...
/// Read-only canonical interval set for `U32CO`.
///
/// A `U32COSet` stores a normalized collection of half-open `U32CO` intervals:
///
...
///
/// Construction is intentionally restricted. Use `U32COSetBuilder` for normal
/// construction.
pub mod set {
    use super::*;
    ...
    mod basic {
        ...
        impl U32COSet {
            ...
            #[inline]
            pub(in crate::u32) unsafe fn new_unchecked(intervals: Vec<U32CO>) -> Self {
            ...
            ///
            /// `U32CO` itself already guarantees single-interval validity. This
            /// function only checks the relationship between adjacent intervals.
            #[inline]
            fn is_canonical(intervals: &[U32CO]) -> bool {
...
/// Concurrent builder for `U32COSet`.
///
...
pub mod builder {
    ...
    use super::set::U32COSet;
    use super::*;

    /// Private ordering key for storing `U32CO` inside `SkipSet`.
    ///
    /// `U32CO` does not need to implement `Ord` in its own crate. This wrapper
    ...
    /// Concurrent write-side builder for `U32COSet`.
    ///
    ...
    pub struct U32COSetBuilder {
        raw: SkipSet<Key>,
    }

    impl U32COSetBuilder {
        ...
        pub fn seal(self) -> U32COSet {
            ...
            // intervals.
            unsafe { U32COSet::new_unchecked(out) }
        }
    }
}
