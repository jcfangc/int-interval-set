...
use crate::i32::funcs_for_canonicalization::{is_canonical, merge, normalize};
...
impl I32COSet {
    ...
    #[inline]
    pub(super) unsafe fn new_unchecked(intervals: Vec<I32CO>) -> Self {
...
impl FromIterator<I32CO> for I32COSet {
        ...
        I: IntoIterator<Item = I32CO>,
    {
        ...
        unsafe { I32COSet::new_unchecked(reduced) }
    }
}

impl FromParallelIterator<I32CO> for I32COSet {
    fn from_par_iter<I>(iter: I) -> Self
    where
        I: IntoParallelIterator<Item = I32CO>,
    {
        let reduced = iter
            .into_par_iter()
            .fold(
                || (Vec::with_capacity(BATCH_SIZE), Vec::<I32CO>::new()),
