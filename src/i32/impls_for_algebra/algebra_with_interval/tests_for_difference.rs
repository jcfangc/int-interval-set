...
fn difference_handles_domain_edges() {
    let set = build([(i32::MIN, i32::MIN + 10), (i32::MAX - 10, i32::MAX)]);

    assert_eq!(
        set.difference_with_interval(iv(i32::MIN, i32::MIN + 5))
            .as_slice(),
        &[iv(i32::MIN + 5, i32::MIN + 10), iv(i32::MAX - 10, i32::MAX)]
    );

    assert_eq!(
        set.difference_with_interval(iv(i32::MAX - 5, i32::MAX))
            .as_slice(),
        &[iv(i32::MIN, i32::MIN + 10), iv(i32::MAX - 10, i32::MAX - 5)]
    );
}
