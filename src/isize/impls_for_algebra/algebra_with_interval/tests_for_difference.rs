...
fn difference_handles_domain_edges() {
    ...
    assert_eq!(
        set.difference_with_interval(iv(isize::MIN, isize::MIN + 5))
            .as_slice(),
        &[iv(isize::MIN + 5, isize::MIN + 10), iv(isize::MAX - 10, isize::MAX)]
    );

    assert_eq!(
        set.difference_with_interval(iv(isize::MAX - 5, isize::MAX))
            .as_slice(),
        &[iv(isize::MIN, isize::MIN + 10), iv(isize::MAX - 10, isize::MAX - 5)]
    );
}
