...
use crate::i64::funcs_for_canonicalization::{is_canonical, merge, normalize};
...
impl I64COSet {
    ...
    #[inline]
    pub(super) unsafe fn new_unchecked(intervals: Vec<I64CO>) -> Self {
...
impl FromIterator<I64CO> for I64COSet {
        ...
        I: IntoIterator<Item = I64CO>,
    {
        ...
        unsafe { I64COSet::new_unchecked(reduced) }
    }
}

impl FromParallelIterator<I64CO> for I64COSet {
    fn from_par_iter<I>(iter: I) -> Self
    where
        I: IntoParallelIterator<Item = I64CO>,
    {
        let reduced = iter
            .into_par_iter()
            .fold(
                || (Vec::with_capacity(BATCH_SIZE), Vec::<I64CO>::new()),
