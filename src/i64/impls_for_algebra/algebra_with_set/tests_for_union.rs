...
fn union_handles_domain_edges() {
    let left = build([(i64::MIN, i64::MIN + 10), (i64::MAX - 10, i64::MAX)]);
    let right = build([(i64::MIN + 10, i64::MAX - 10)]);
...
proptest! {
    ...
    fn prop_union_matches_pointwise_membership(
        ...
        let left: I64COSet = xs.into_iter().collect();
        let right: I64COSet = ys.into_iter().collect();
