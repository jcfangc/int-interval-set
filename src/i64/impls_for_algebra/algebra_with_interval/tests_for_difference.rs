...
fn difference_handles_domain_edges() {
    let set = build([(i64::MIN, i64::MIN + 10), (i64::MAX - 10, i64::MAX)]);

    assert_eq!(
        set.difference_with_interval(iv(i64::MIN, i64::MIN + 5))
            .as_slice(),
        &[iv(i64::MIN + 5, i64::MIN + 10), iv(i64::MAX - 10, i64::MAX)]
    );

    assert_eq!(
        set.difference_with_interval(iv(i64::MAX - 5, i64::MAX))
            .as_slice(),
        &[iv(i64::MIN, i64::MIN + 10), iv(i64::MAX - 10, i64::MAX - 5)]
    );
}
