...
fn intersections_handles_domain_edges() {
    ...
    assert_eq!(
        set.intersection_with_interval(iv(i64::MIN, i64::MIN + 1))
            .as_slice()
            .to_vec(),
        vec![iv(i64::MIN, i64::MIN + 1)]
    );
    assert_eq!(
        set.intersection_with_interval(iv(i64::MAX - 1, i64::MAX))
            .as_slice()
            .to_vec(),
        vec![iv(i64::MAX - 1, i64::MAX)]
    );
}
