...
fn union_handles_domain_edges() {
    let left = build([(u16::MIN, u16::MIN + 10), (u16::MAX - 10, u16::MAX)]);
    let right = build([(u16::MIN + 10, u16::MAX - 10)]);
...
proptest! {
    ...
    fn prop_union_matches_pointwise_membership(
        ...
        let left: U16COSet = xs.into_iter().collect();
        let right: U16COSet = ys.into_iter().collect();
