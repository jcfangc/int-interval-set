...
#[inline]
pub(super) fn is_canonical(intervals: &[U16CO]) -> bool {
    intervals.windows(2).all(|w| w[0].end_excl() < w[1].start())
}

#[inline]
pub(super) fn normalize(mut intervals: Vec<U16CO>) -> Vec<U16CO> {
    intervals.sort_unstable();
    canonicalize_sorted(intervals)
}

#[inline]
pub(super) fn merge(left: Vec<U16CO>, right: Vec<U16CO>) -> Vec<U16CO> {
    if left.is_empty() {
        return right;
    }
...
pub(super) fn canonicalize_sorted<I>(intervals: I) -> Vec<U16CO>
where
    I: IntoIterator<Item = U16CO>,
{
...
pub(super) fn merge_sorted<I, J>(left: I, right: J) -> impl Iterator<Item = U16CO>
where
    I: IntoIterator<Item = U16CO>,
    J: IntoIterator<Item = U16CO>,
{
    struct Merge<I, J>
    where
        I: Iterator<Item = U16CO>,
        J: Iterator<Item = U16CO>,
    {
