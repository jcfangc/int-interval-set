...
use crate::u16::funcs_for_canonicalization::{is_canonical, merge, normalize};
...
impl U16COSet {
    ...
    #[inline]
    pub(super) unsafe fn new_unchecked(intervals: Vec<U16CO>) -> Self {
...
impl FromIterator<U16CO> for U16COSet {
        ...
        I: IntoIterator<Item = U16CO>,
    {
        ...
        unsafe { U16COSet::new_unchecked(reduced) }
    }
}

impl FromParallelIterator<U16CO> for U16COSet {
    fn from_par_iter<I>(iter: I) -> Self
    where
        I: IntoParallelIterator<Item = U16CO>,
    {
        let reduced = iter
            .into_par_iter()
            .fold(
                || (Vec::with_capacity(BATCH_SIZE), Vec::<U16CO>::new()),
