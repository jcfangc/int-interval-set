...
/// Read-only canonical interval set for `I16CO`.
///
/// A `I16COSet` stores a normalized collection of half-open `I16CO` intervals:
///
...
///
/// Construction is intentionally restricted. Use `I16COSetBuilder` for normal
/// construction.
pub mod set {
    use super::*;
    ...
    mod basic {
        ...
        impl I16COSet {
            ...
            #[inline]
            pub(in crate::i16) unsafe fn new_unchecked(intervals: Vec<I16CO>) -> Self {
            ...
            #[inline]
            fn is_canonical(intervals: &[I16CO]) -> bool {
...
/// Concurrent builder for `I16COSet`.
///
...
pub mod builder {
    ...
    use super::set::I16COSet;
    use super::*;

    /// Private ordering key for storing `I16CO` inside `SkipSet`.
    ///
    /// `I16CO` does not need to implement `Ord` in its own crate. This wrapper
    ...
    impl I16COSetBuilder {
        ...
        pub fn seal(self) -> I16COSet {
            ...
            let Some(mut cur) = iter.next() else {
                ...
                return unsafe { I16COSet::new_unchecked(Vec::new()) };
            };
            ...
            // intervals.
            unsafe { I16COSet::new_unchecked(out) }
        }
    }
}
