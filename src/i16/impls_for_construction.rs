...
use crate::i16::funcs_for_canonicalization::{is_canonical, merge, normalize};
...
impl I16COSet {
    ...
    #[inline]
    pub(super) unsafe fn new_unchecked(intervals: Vec<I16CO>) -> Self {
...
impl FromIterator<I16CO> for I16COSet {
        ...
        I: IntoIterator<Item = I16CO>,
    {
        ...
        unsafe { I16COSet::new_unchecked(reduced) }
    }
}

impl FromParallelIterator<I16CO> for I16COSet {
    fn from_par_iter<I>(iter: I) -> Self
    where
        I: IntoParallelIterator<Item = I16CO>,
    {
        let reduced = iter
            .into_par_iter()
            .fold(
                || (Vec::with_capacity(BATCH_SIZE), Vec::<I16CO>::new()),
