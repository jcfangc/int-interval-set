...
fn union_handles_domain_edges() {
    let left = build([(i16::MIN, i16::MIN + 10), (i16::MAX - 10, i16::MAX)]);
    let right = build([(i16::MIN + 10, i16::MAX - 10)]);
...
proptest! {
    ...
    fn prop_union_matches_pointwise_membership(
        ...
        let left: I16COSet = xs.into_iter().collect();
        let right: I16COSet = ys.into_iter().collect();
