...
fn intersections_handles_domain_edges() {
    ...
    assert_eq!(
        set.intersection_with_interval(iv(i16::MIN, i16::MIN + 1))
            .as_slice()
            .to_vec(),
        vec![iv(i16::MIN, i16::MIN + 1)]
    );
    assert_eq!(
        set.intersection_with_interval(iv(i16::MAX - 1, i16::MAX))
            .as_slice()
            .to_vec(),
        vec![iv(i16::MAX - 1, i16::MAX)]
    );
}
