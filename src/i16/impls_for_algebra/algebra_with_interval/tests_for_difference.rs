...
fn difference_handles_domain_edges() {
    let set = build([(i16::MIN, i16::MIN + 10), (i16::MAX - 10, i16::MAX)]);

    assert_eq!(
        set.difference_with_interval(iv(i16::MIN, i16::MIN + 5))
            .as_slice(),
        &[iv(i16::MIN + 5, i16::MIN + 10), iv(i16::MAX - 10, i16::MAX)]
    );

    assert_eq!(
        set.difference_with_interval(iv(i16::MAX - 5, i16::MAX))
            .as_slice(),
        &[iv(i16::MIN, i16::MIN + 10), iv(i16::MAX - 10, i16::MAX - 5)]
    );
}
