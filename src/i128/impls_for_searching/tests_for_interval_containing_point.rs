...
fn returns_none_on_empty_set() {
    ...
    assert_eq!(set.interval_containing_point(i128::MIN), None);
    assert_eq!(set.interval_containing_point(i128::MAX / 2), None);
    assert_eq!(set.interval_containing_point(i128::MAX), None);
}
...
fn handles_domain_edges() {
    ...
    assert_eq!(
        set.interval_containing_point(i128::MIN),
        Some(iv(i128::MIN, i128::MIN + 1))
    );
    assert_eq!(set.interval_containing_point(i128::MIN + 1), None);

    assert_eq!(
        set.interval_containing_point(i128::MAX - 1),
        Some(iv(i128::MAX - 1, i128::MAX))
    );
    assert_eq!(set.interval_containing_point(i128::MAX), None);
}
...
fn representative_points_match_contains_point_predicate() {
    ...
    for x in [i128::MIN, 9, 10, 19, 20, 30, 39, 40, 55, 60, i128::MAX] {
        assert_eq!(
