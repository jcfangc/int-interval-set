...
use crate::i128::funcs_for_canonicalization::{is_canonical, merge, normalize};
...
impl I128COSet {
    ...
    #[inline]
    pub(super) unsafe fn new_unchecked(intervals: Vec<I128CO>) -> Self {
...
impl FromIterator<I128CO> for I128COSet {
        ...
        I: IntoIterator<Item = I128CO>,
    {
        ...
        unsafe { I128COSet::new_unchecked(reduced) }
    }
}

impl FromParallelIterator<I128CO> for I128COSet {
    fn from_par_iter<I>(iter: I) -> Self
    where
        I: IntoParallelIterator<Item = I128CO>,
    {
        let reduced = iter
            .into_par_iter()
            .fold(
                || (Vec::with_capacity(BATCH_SIZE), Vec::<I128CO>::new()),
