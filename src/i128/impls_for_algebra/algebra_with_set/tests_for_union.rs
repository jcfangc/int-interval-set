...
fn union_handles_domain_edges() {
    let left = build([(i128::MIN, i128::MIN + 10), (i128::MAX - 10, i128::MAX)]);
    let right = build([(i128::MIN + 10, i128::MAX - 10)]);

    assert_eq!(
        left.union_with_set(&right).as_slice(),
        &[iv(i128::MIN, i128::MAX)]
    );
}
...
proptest! {
    ...
    fn prop_union_matches_pointwise_membership(
        ...
        let left: I128COSet = xs.into_iter().collect();
        let right: I128COSet = ys.into_iter().collect();
