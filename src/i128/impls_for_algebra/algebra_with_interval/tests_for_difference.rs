...
fn difference_handles_domain_edges() {
    let set = build([(i128::MIN, i128::MIN + 10), (i128::MAX - 10, i128::MAX)]);

    assert_eq!(
        set.difference_with_interval(iv(i128::MIN, i128::MIN + 5))
            .as_slice(),
        &[iv(i128::MIN + 5, i128::MIN + 10), iv(i128::MAX - 10, i128::MAX)]
    );

    assert_eq!(
        set.difference_with_interval(iv(i128::MAX - 5, i128::MAX))
            .as_slice(),
        &[iv(i128::MIN, i128::MIN + 10), iv(i128::MAX - 10, i128::MAX - 5)]
    );
}
